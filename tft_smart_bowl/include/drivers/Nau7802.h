 ...
 * at a higher level (WeightService). This driver only handles hardware configuration
...
public:
     ...
     * @param rate 0=10SPS, 1=20SPS, 2=40SPS, 3=80SPS, 7=320SPS (matches SparkFun NAU7802_SPS_Values)
